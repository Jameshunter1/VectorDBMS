...
std::vector<AuditEntry> AuditLogger::GetEntriesInTimeRange(
...
std::string AuditLogger::EventTypeToString(EventType type) const {
  switch (type) {
    case EventType::kLogin: return "LOGIN";
    case EventType::kLogout: return "LOGOUT";
    case EventType::kLoginFailed: return "LOGIN_FAILED";
    case EventType::kPut: return "PUT";
    case EventType::kGet: return "GET";
    case EventType::kDelete: return "DELETE";
    case EventType::kBatchOperation: return "BATCH";
    case EventType::kExport: return "EXPORT";
    case EventType::kClearDatabase: return "CLEAR_DB";
    case EventType::kConfigChange: return "CONFIG";
    case EventType::kUserCreated: return "USER_CREATED";
    case EventType::kUserDeactivated: return "USER_DEACTIVATED";
    case EventType::kSessionExpired: return "SESSION_EXPIRED";
    case EventType::kUnauthorizedAccess: return "UNAUTHORIZED";
...
void AuditLogger::WriteToFile(const AuditEntry& entry) {
  ...
  log_file_ << "[" << TimeToString(entry.timestamp) << "] "
            << EventTypeToString(entry.event_type) << " "
